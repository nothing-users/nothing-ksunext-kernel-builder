...
The stock image comes from Nothing Archive's [`Asteroids_B4.1-260618-1048` release](https://github.com/spike0en/nothing_archive/releases/tag/Asteroids_B4.1-260618-1048). The exact URL, archive SHA-256, and extracted `boot.img` SHA-256 are pinned in the workflow. Nothing Archive is credited as required; OEM firmware remains the property of Nothing Technology Limited and is not stored in this repository.
